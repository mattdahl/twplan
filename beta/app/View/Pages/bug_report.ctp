...
<p>If you need urgent assistance, you can reach Syntex (Matt) directly via PM on the <a href="http://forum.tribalwars.net/member.php?90426-syntexgrid">TW Forum</a> or via Skype at <i>syntexgrid</i>.</p>
...
<p>
  <b>What browser and version are you using?</b> <br />
  <textarea class="bug_report_item" ng-model="bug_report.browser"></textarea>
</p>

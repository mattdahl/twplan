...
include_path = ".:/usr/share/php:/usr/local/lib/zend/ZendFramework/library:/usr/local/lib/zend/ZendFramework/"
;
...
;
;extension=ExactImage.so
;extension=adodb.so
;extension=big_int.so
;extension=curl.so
...
;extension=phpshield_loader.lin
;extension=ps.so
;extension=pspell.so
;extension=radius.so
;extension=recode.so
...
zend_extension=/usr/lib/php5/20090626/ioncube_loader_lin.so

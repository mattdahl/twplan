...
PlanModule.run(['$rootScope', 'Steps', function ($rootScope, Steps) {
	$rootScope.villages = [];
	$rootScope.targets = [];

	$rootScope.current_step = Steps.StepOne;
...
PlanModule.factory('Steps', function () {
	return {
		StepOne: 0,
		StepTwo: 1,
		StepThree: 2
 ...
 */
PlanModule.controller('StepOneController', ['$rootScope', '$scope', 'Villages', 'GroupNames', 'Units', 'AttackTypes', 'Steps', function ($rootScope, $scope, Villages, GroupNames, Units, AttackTypes, Steps) {
	$scope.villages = [];
	$scope.villages_in_plan = {
		villages: [],
		nukes: 0,
		nobles: 0,
		supports: 0
	...
	$scope.submitStepOne = function () {
		if ($scope.villages_in_plan.villages.length == 0) {
			...
			$rootScope.villages = $scope.villages_in_plan.villages;

			$('#step_one_container').fadeOut('slow');
			$('#step_two_container').show('fast');
			$('html, body').animate({scrollTop: 0}, 100);

			$rootScope.current_step = Steps.StepTwo;
		}
...
PlanModule.controller('StepTwoController', ['$rootScope', '$scope', 'AttackTypes', 'Steps', function ($rootScope, $scope, AttackTypes, Steps) {
	$scope.targets_in_plan = {
		targets: [],
		nukes: [],
		nobles: [],
		supports: []
